    ...
    return(
        <section id="sectionExperiencia" className={`${estilos.containerSection} ${tema ? 'darkMode': ''}`}>
            ...
            <div className={estilos.containerCards}>
                ...
                <Card titulo={'Treinamento'} paragrafo={'Treinamento personalizado na medida certa para sua empresa. O que sua equipe precisa?'} icone={<FcVoicePresentation className={estilos.icone}/>}/>
            </div>
        </section>
    );
};